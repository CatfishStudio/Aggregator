...
namespace Aggregator.Client.Directories
{
	partial class FormConstants
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox2.Text = "Контактные лица:";
			// 
			// button8
			// 
			this.button8.FlatStyle = System.Windows.Forms.FlatStyle.Popup;
			this.button8.Location = new System.Drawing.Point(394, 69);
			...
			this.button7.Location = new System.Drawing.Point(394, 46);
			...
			this.button6.Location = new System.Drawing.Point(394, 23);
			...
			this.label6.Text = "Лицо отправляющее заказы:";
			// 
			// textBox5
			// 
			this.textBox5.Location = new System.Drawing.Point(165, 46);
			...
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(165, 23);
			...
			this.label2.Text = "Элктронная почта:";
			// 
			// textBox1
			// 
