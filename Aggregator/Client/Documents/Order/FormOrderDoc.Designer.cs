...
namespace Aggregator.Client.Documents.Order
{
	partial class FormOrderDoc
	{
		...
		private void InitializeComponent()
		{
			...
			this.panel2.Controls.Add(this.counteragentTextBox);
			...
			// docNumberTextBox
			// 
			this.docNumberTextBox.Location = new System.Drawing.Point(98, 9);
			...
			this.docNumberTextBox.Text = "ЗА-0000000";
			// 
			// label1
			// 
			...
			// tabPage1
			// 
			this.tabPage1.Controls.Add(this.listViewNomenclature);
